...
class Cart extends Model {
    ...
    public function getProducts() {
        ...
        b.vlheight, b.vllength, b.vlweight, b.desurl, COUNT(*) AS nrqtd, SUM(b.vlprice) AS vltotal
        FROM tb_cartsproducts a 
        INNER JOIN tb_products b ON a.idproduct = b.idproduct 
        WHERE a.idcart = :idcart AND a.dtremoved IS NULL 
        GROUP BY b.idproduct, b.desproduct, b.vlprice, b.vlwidth, b.vlheight,
        b.vllength, b.vlweight, b.desurl ORDER BY b.desproduct", [
    ...
    public function getProductsTotals() {
        ...
        $results = $sql->select(
           "SELECT SUM(vlprice) AS vlprice, SUM(vlwidth) AS vlwidth,
            ...
            FROM tb_products a INNER JOIN tb_cartsproducts b 
    ...
    public function setFreight($nrzipcode) {
        ...
        if($totals['nrqtd'] > 0) {
            ...
            if($result->MsgErro != '') {
                ...
                Cart::setMsgError($resul->MsgErro);
    ...
    public function getCalculateTotal() {
        ...
        $this->setvltotal($totals['vlprice'] + $this->getvlfreigjht);
