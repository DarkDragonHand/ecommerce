...
class User extends Model{
    ...
    public static function listAll() {
        ...
        return $sql->select("SELECT * FROM tb_users a INNER JOIN 
        tb_persons b USING(idperson) ORDER BY b.desperson");
    ...
    public function save() {
        ...
        (:desperson, :deslogin, :despassword, :desemail, :nhphone, :inadmin", array(
            ":desperson"   => $this->getdesperson(),
            ":deslogin"    => $this->getdeslogin(),
            ":despassword "=> User::getPasswordHash($this->getdespassword()),
            ":desemail"    => $this->getdesemail(),
            ":nhphone"     => $this->getnrphone(),
    ...
    public function get($iduser) {
        ...
        a INNER JOIN tb_persons b USING(idperson)
    ...
    public function update() {
        ...
        $results = 
        $sql->select("CALL sp_usersupdate_save
        (:iduser, :desperson, :deslogin, :despassword, :desemail, :nhphone, :inadmin", array(
    ...
    public static function getForgot($email, $inadmin = true) {
        ...
        if(count($results) === 0) {
            ...
            $results2 = $sql->select("CALL 
            sp_userspasswordsrecoveries_create(:iduser, :desip)", array(
                ":iduser" => $data["iduser"],
            ...
            if(count($results2) === 0) {
                ...
                $mailer = new Mailer(
                    ...
                    "Redefinir senha da Guilherme Store", "forgot", array(
                        "name" => $data["desperson"],
                        "link" => $link,
                    ));
    ...
    public static function validForgotDecrypt($code) {
        ...
        $idrecovery = openssl_decrypt(MCRYPT_RIJNDAEL_128, User::SECRET,
        base64_decode($code), MCRYPT_MODE_ECB);

        $sql = new Sql();

        $results = $sql->select("
            SELECT * ROM tb_userspasswordsrecoveries a
    ...
    public static function getPageSearch($search, $page = 1, $itemsPerPage = 10) {
        ...
        $results = $sql->select(
            "SELECT SQL_CALC_FOUND_ROWS * 
             ...
             USING(idperson) 
             WHERE b.desperson 
             LIKE :search OR b.desemail = :search OR a.deslogin LIKE :search
