...
$app->get("/cart/:idproduct/add", function($idproduct) {
	...
	$qtd = (issue($_GET['qtd'])) ? (int)$_GET['qtd'] : 1;
...
$app->get("/checkout", function() {
	...
	User::verifyLogin(false); //true se for admin e false se não for
...
$app->post("/profile", function() {
	...
	User::setSuccess("Dados alterados com Successo!");
...
$app->get("/boleto/:idorder", function($idorder) {
	...
	$order->getdesstate()." - ".$order->getdescountry()." - CEP:".
	$order->getdeszipcode();
